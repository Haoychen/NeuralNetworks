...
def test_mlp_dropout(learning_rate, L1_reg, L2_reg, n_epochs,
             batch_size, n_hidden, verbose, hidlayers, acttest=T.tanh, p=0.5):
    """
    ...
    L2_sqr = (hiddenlayer_one.W ** 2).sum() + (hiddenlayer_two.W ** 2).sum() + (logRegressionLayer.W ** 2).sum()
...
if __name__ == '__main__':
    ...
    for i in [1,2,3,4,5,6,7,8]:
        com = test_mlp_dropout(1,0.00,0.0001,1,20,50,True,i)
        y.append(com)
        del com
    print(y) 
